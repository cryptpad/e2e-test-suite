...
test('anon - sign up and delete account', async ({ page }) => {
...
// test('user - add other user as contact and decline request', async ({ page }, testInfo) => {
...
// test('user - add and remove other user as contact', async ({ page }, testInfo) => {
...
// test('user - request and cancel to add user as contact', async ({ page }) => {
...
// test('user - chat with contacts and erase message history', async ({ page }, testInfo) => {
...
test('user - can access public signing key', async ({ page }) => {
