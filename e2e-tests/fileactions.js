...
*/
  ...
  shareNotif (user, fileName) {
    const titles = this.getTitle(fileName);
    const title = titles[0];
    const titleComma = titles[1];
    const titleTwoCommas = titles[2];
  ...
  getTitle (fileName) {
    ...
    const titleDate = `${name} - ${this.titleDate}`;
    const titleDateComma = `${name} - ${this.titleDateComma}`;
    const titleDateTwoCommas = `${name} - ${this.titleDateTwoCommas}`;
    const titleDateNoYear = `${name} - ${this.titleDateNoYear}`;
