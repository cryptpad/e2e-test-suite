...
test.describe('New file modal', () => {
    test(`Explore new file modal from pad.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Share modal', () => {
    test(`Explore share modal from pad.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Chat modal', () => {
    test(`Explore chat modal for pad`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Change title', () => {
    test(`Change title for pad`, async ({ page, context }, testInfo) => {
      try {
        // Load a new document.
...
test.describe('Save/Remove ', () => {
    test(`Save and remove for pad`, async ({ page, context }, testInfo) => {
      try {
