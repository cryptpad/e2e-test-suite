...
test.describe('New file modal', () => {
    test(`Explore new file modal from whiteboard.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Share modal', () => {
    test(`Explore share modal from whiteboard.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Chat modal', () => {
    test(`Explore chat modal for whiteboard`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Change title', () => {
    test(`Change title for whiteboard`, async ({ page, context }, testInfo) => {
      try {
        // Load a new document.
...
test.describe('Save/Remove ', () => {
    test(`Save and remove for whiteboard`, async ({ page, context }, testInfo) => {
      try {
