...
test.describe('New file modal', () => {
    test(`Explore new file modal from form.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Share modal', () => {
    test(`Explore share modal from form.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Chat modal', () => {
    test(`Explore chat modal for form`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Change title', () => {
    test(`Change title for form`, async ({ page, context }, testInfo) => {
      try {
        // Load a new document.
...
test.describe('Save/Remove ', () => {
    test(`Save and remove for form`, async ({ page, context }, testInfo) => {
      try {
