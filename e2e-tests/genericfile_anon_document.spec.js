...
test.describe('New file modal', () => {
    test(`Explore new file modal from document.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Share modal', () => {
    test(`Explore share modal from document.`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Chat modal', () => {
    test(`Explore chat modal for document`, async ({ page, context }, testInfo) => {
      try {
...
test.describe('Change title', () => {
    test(`Change title for document`, async ({ page, context }, testInfo) => {
      try {
        // Load a new document.
...
test.describe('Save/Remove ', () => {
    test(`Save and remove for document`, async ({ page, context }, testInfo) => {
      try {
